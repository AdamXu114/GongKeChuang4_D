...
uint8_t hsp_menu_core(void)
{
	...
	hsp_tft18_show_str(32, 0, menu_item_core[0]);
	hsp_tft18_show_str(32, 1, menu_item_core[1]);
	hsp_tft18_show_str(32, 2, menu_item_core[2]);
	hsp_tft18_show_str(32, 3, menu_item_core[3]);
	hsp_tft18_show_str(32, 4, menu_item_core[4]);
	hsp_tft18_show_str(32, 5, menu_item_core[5]);
	hsp_tft18_show_str(32, 6, menu_item_core[6]);
	hsp_tft18_show_str(32, 7, menu_item_core[7]);
...
uint8_t hsp_menu_board(void)
{
	...
	hsp_tft18_show_str(32, 0, menu_item_board[0]);
	hsp_tft18_show_str(32, 1, menu_item_board[1]);
	hsp_tft18_show_str(32, 2, menu_item_board[2]);
	hsp_tft18_show_str(32, 3, menu_item_board[3]);
	hsp_tft18_show_str(32, 4, menu_item_board[4]);
	hsp_tft18_show_str(32, 5, menu_item_board[5]);
	hsp_tft18_show_str(32, 6, menu_item_board[6]);
	hsp_tft18_show_str(32, 7, menu_item_board[7]);
...
uint8_t hsp_menu_car(void)
{
	...
	hsp_tft18_show_str(32, 0, menu_item_car[0]);
	hsp_tft18_show_str(32, 1, menu_item_car[1]);
	hsp_tft18_show_str(32, 2, menu_item_car[2]);
	hsp_tft18_show_str(32, 3, menu_item_car[3]);
	hsp_tft18_show_str(32, 4, menu_item_car[4]);
	hsp_tft18_show_str(32, 5, menu_item_car[5]);
	hsp_tft18_show_str(32, 6, menu_item_car[6]);
	hsp_tft18_show_str(32, 7, menu_item_car[7]);
