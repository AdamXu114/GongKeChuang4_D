...
// v1:: Encoder: Timer3_CH2(PD14/PHB1) / Timer3_CH3(PD15/PHA1)
// v2:: Encoder: Timer3_CH0(PD12/PHB1) / Timer3_CH1(PD13/PHA1)
...
void hsp_qdec_init(void)
{
	...
	// Encoder PHB1: PD12/AF2 - Timer3_CH0
	// Encoder PHA1: PD13/AF2 - Timer3_CH1
	...
	/* TIMER3 CH0 & CH1 configure in encoder mode 0 */
	...
	timer_quadrature_decoder_mode_config(TIMER3, TIMER_QUAD_DECODER_MODE2, TIMER_IC_POLARITY_RISING, TIMER_IC_POLARITY_RISING);
...
// v1: PD12/TIMER3_CH0 conflict with SW2 configure, use only one at a time
// v2: PD13/TIMER3_CH1
