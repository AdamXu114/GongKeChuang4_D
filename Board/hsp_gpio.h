...
// v2
#define SW1()	gpio_input_bit_get(GPIOD, GPIO_PIN_14)
...
// v1
// #define KEY2()	gpio_input_bit_get(GPIOD, GPIO_PIN_13)
// v2
...
// v2
#define BUZZ_ON()		gpio_bit_set(GPIOA, GPIO_PIN_8)
#define BUZZ_OFF()		gpio_bit_reset(GPIOA, GPIO_PIN_8)
#define BUZZ_TOGGLE()	gpio_bit_toggle(GPIOA, GPIO_PIN_8)
...
// v2
#define LED2_ON()       gpio_bit_set(GPIOA, GPIO_PIN_12)
#define LED2_OFF()      gpio_bit_reset(GPIOA, GPIO_PIN_12)
#define LED2_TOGGLE()   gpio_bit_toggle(GPIOA, GPIO_PIN_12)
