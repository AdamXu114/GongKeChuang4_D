...
void hsp_gpio_init()
{
    ...
    /* PortD inputs on base board: SW4/PD9, SW3/PD10, SW2/PD11, SW1/PD12, KEY2/PD13=>PD15(fly wire) */
    //gpio_mode_set(GPIOD, GPIO_MODE_INPUT, GPIO_PUPD_NONE, GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_12 | GPIO_PIN_15);
    // v2
    /* PortD inputs on base board: SW4/PD9, SW3/PD10, SW2/PD11, SW1/PD14, KEY2/PD15 */
    gpio_mode_set(GPIOD, GPIO_MODE_INPUT, GPIO_PUPD_NONE, GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_14 | GPIO_PIN_15);
    ...
    /* PortA outputs on system board: led_r/PA7, BUZZ/PA12(v1) => BUZZ/PA8(v2) */
    /* PortA outputs on base board: LED2/PA8(v1) => LED2/PA12(V2) */
    ...
    gpio_bit_reset(GPIOA, GPIO_PIN_8);     	// clear to turn off LED2(v1) => BUZZ(v2)
    gpio_bit_reset(GPIOA, GPIO_PIN_12);    	// clear to turn off BUZZ(v1) => LED2(v2)
